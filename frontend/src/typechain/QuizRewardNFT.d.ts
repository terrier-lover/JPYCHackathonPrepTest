...
interface QuizRewardNFTInterface extends ethers.utils.Interface {
  functions: {
    ...
    "originalMinters(uint256)": FunctionFragment;
...
export class QuizRewardNFT extends BaseContract {
  ...
  interface: QuizRewardNFTInterface;
